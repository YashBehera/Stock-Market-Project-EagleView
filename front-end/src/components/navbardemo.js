      ...
      <nav className="navbar flex items-center justify-between px-6 py-2 w-screen bg-gray-900 text-white shadow-md sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-2">
            <div className="flex flex-col items-center px-3 py-1 rounded-lg hover:bg-gray-800 transition-all">
              <span className="text-xs">Nifty 50</span>
              <span className="text-sm font-semibold text-green-400 flex items-center">
                {price1 || "Loading..."} <FaCaretUp className="ml-1" />
              </span>
            </div>
            <div className="flex flex-col items-center px-3 py-1 rounded-lg hover:bg-gray-800 transition-all">
              <span className="text-xs">Bank Nifty</span>
              <span className="text-sm font-semibold text-red-400 flex items-center">
                {price2 || "Loading..."} <FaCaretDown className="ml-1" />
              </span>
            </div>
            <div className="flex flex-col items-center px-3 py-1 rounded-lg hover:bg-gray-800 transition-all">
              <span className="text-xs">Sensex</span>
              <span className="text-sm font-semibold text-green-400 flex items-center">
                {price3 || "Loading..."} <FaCaretUp className="ml-1" />
              </span>
            </div>
          </div>
          <button
