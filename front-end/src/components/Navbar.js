      ...
      <div className="flex items-center gap-5 h-14 w-64 text-3xl text-white z-0">
        ...
        <div className="flex items-center">
          <div className="flex items-center gap-1">
            <button className="font-bold" onClick={handleScreenerClick}>EagleView</button>
        ...
        <form>
          <div className="flex items-center justify-center gap-4 font-bold">
            <button className="flex-row h-10 w-20 hover:bg-zinc-700 rounded-3xl mt-0">
              <span className="flex items-center justify-center font-bold leading-5" onClick={handleMarketWatchClick}>
                Market Watch
              </span>
            </button>

            <button className="flex-row h-10 w-20 hover:bg-zinc-700 rounded-3xl mt-0" onClick={handleScreenerClick}>
              <span className="flex items-center justify-center">Screener</span>
            </button>
            <div className="flex-row h-10 w-24 hover:bg-zinc-700 rounded-3xl leading-5 mt-0">
            ...
            <button className="flex-row h-10 w-24 hover:bg-zinc-700 rounded-3xl leading-4 mt-0" onClick={handleWatchlistClick}>
              <span className="flex items-center justify-center">
                Watchlist
              </span>
        ...
        <button onClick={toggleDropdown}>
          ...
          {userDetails ? (
            ...
            {userDetails ? (
              ...
              <div>
              <CgProfile className="flex justify-center items-center text-black ml-5" />
